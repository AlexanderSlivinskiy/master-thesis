...
\end{tikzpicture}
\caption[Transformation into $\twoSucc$]{An example of transforming an $\SG$ into one fulfilling the $\twoSucc$-constraint. $s_0$ has more than two actions, so a binary subtree is built up where each states except for the leaves $f_1, f_2, \zeroSink$ has exactly two actions.}
\label{ex:2Succ}
\end{figure}
...
\draw[->] (init) to (q);
\redmid  (q) to node [left ,midway] {$\mathsf{b}$}(mid);
\redarr (mid) to node [midway, above] {$\frac{1}{2}$} (0);
\redarr (mid) to node [midway, right] {$\frac{1}{2}$} (12);
\redarr  (q) to node [left ,midway] {$\mathsf{a}$}(0);
...
\drawdummy (spacer) at (9.5, 2) {};
\drawdummy (init) at (4,2) {};
\drawbox (q) at (4,0) {$\mathsf{s_0}$};
\drawboxred (p) at (2,-4){$\mathsf{s_1'}$}; 
...
\draw[->] (init) to (q);
\redmid (p) to node [left ,midway] {$\mathsf{b}$}(mid);
\redarr (mid) to node [midway, above] {$\frac{1}{2}$} (0);
\redarr (mid) to node [midway, above] {$\frac{1}{2}$} (12);
\redarr  (p) to node [left ,midway] {$\mathsf{a}$}(0);
\draw[->]  (q) to node [right ,midway] {$\mathsf{b}$}(11);
\redarr  (q) to node [left ,midway] {$\mathsf{a}$}(p);
